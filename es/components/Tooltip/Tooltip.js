...
function (_Component) {
  function Tooltip() {
    ...
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_debouncedHandleHover", debounce(_this._handleHover, 200)), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouse", function (evt) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      }, triggerText, React.createElement("div", {
        id: triggerId,
        role: "button",
        tabIndex: "0",
